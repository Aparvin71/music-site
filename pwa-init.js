const AINEO_APP_VERSION = "v42.3.76b";
    ...
    <div class="app-feel-surface-panel" role="dialog" aria-modal="true" aria-labelledby="appFeelSurfaceTitle">
      ...
      <div class="app-feel-surface-body">
        ...
        <section class="app-feel-group">
          ...
          <p class="page-lead compact-lead">Version <span class="app-version">v42.3.76b</span> is tuned for a cleaner iPhone standalone experience.</p>
        </section>
      </div>
    </div>
  `;
