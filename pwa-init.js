const AINEO_APP_VERSION = "v42.5.2";
    ...
    <div class="app-feel-surface-panel" role="dialog" aria-modal="true" aria-labelledby="appFeelSurfaceTitle">
      ...
      <div class="app-feel-surface-body">
        ...
        <section class="app-feel-group">
          ...
          <p class="page-lead compact-lead">Version <span class="app-version">v42.5.2</span></p>
          <p class="mission-statement mission-statement--summary">This build keeps install and offline help tucked inside Settings &amp; About by default, and upgrades the player visualizer into a taller blue-purple bar wave that follows each track's saved waveform profile behind the artwork.</p>
        </section>
      </div>
    </div>
  `;
...
const APP_RUNTIME_VERSION = "v42.5.2";
