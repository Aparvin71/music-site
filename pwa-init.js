...
const AINEO_APP_VERSION = "v43.2.24";
    ...
    <div class="app-feel-surface-panel" role="dialog" aria-modal="true" aria-labelledby="appFeelSurfaceTitle">
      ...
      <div class="app-feel-surface-body">
        ...
        <section class="app-feel-group">
          ...
          <p class="page-lead compact-lead">Version <span class="app-version">v43.2.24</span></p>
...
function ensureFloatingSettingsButton() {
  // v43.2.24: Top-right floating app-feel/settings ellipsis removed by request.
...
const APP_RUNTIME_VERSION = "v43.2.24";


const APP_SHELL_RESET_VERSION_KEY = "aineo_app_shell_reset_version";
const APP_SHELL_RESET_TARGET = "v43.2.24";
...
const LYRICS_LIBRARY_VERSION = "43.2.24";
