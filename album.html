...
<head>
  ...
  <link rel="stylesheet" href="./style.css?v=42.3.99" />
  <script src="./pwa-init.js?v=42.3.99" defer></script>
  <script src="./aineo-shared.js?v=42.3.99" defer></script>
  <script src="./aineo-album-page.js?v=42.3.99" defer></script>
  <script src="./album-page.js?v=42.3.99" defer></script>
</head>
<body>
  ...
  <div class="sticky-player" aria-label="Audio player">
    ...
    <p>© 2026 Aineo Music <span class="footer-sep">·</span> <span class="app-version">v42.4.2</span></p>
